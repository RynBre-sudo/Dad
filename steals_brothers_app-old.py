...
with st.sidebar:
    ...
    <div style='margin-top:2rem; padding:1rem; border:1px solid rgba(201,168,76,0.15);
        ...
        <div style='font-family:"Playfair Display",serif; font-size:0.95rem;
                    color:#C9A84C; margin-top:0.3rem; line-height:1.3;'>
            Best Dance Recording
        </div>
        <div style='font-family:"Cormorant Garamond",serif; font-size:0.75rem;
                    font-style:italic; color:rgba(245,237,214,0.5); margin-top:0.2rem;'>
            2021 — "10%" · Kaytranada
        </div>
    </div>
    """, unsafe_allow_html=True)
...
if "Home" in page:
    ...
    with col1:
        ...
        <p style='font-family:"Playfair Display",serif;font-size:2.4rem;font-weight:900;
                  color:rgba(245,237,214,0.95);line-height:1.2;margin-bottom:1.2rem;'>
    ...
    with col2:
        ...
        <div style='display:grid;grid-template-columns:1fr 1fr;gap:1rem;margin-bottom:1rem;'>
            <div style='background:linear-gradient(160deg,rgba(201,168,76,0.12),rgba(201,168,76,0.03));
                ...
                <div style='font-family:"Cormorant Garamond",serif;font-style:italic;
                            font-size:0.78rem;color:rgba(245,237,214,0.55);margin-top:0.2rem;'>"Lyric"</div>
                <div style='font-family:"Raleway",sans-serif;font-size:0.65rem;
                            text-transform:uppercase;letter-spacing:0.12em;color:#9A8A6A;
                            margin-top:0.5rem;'>Wordsmith</div>
            </div>
            <div style='background:linear-gradient(160deg,rgba(42,74,107,0.2),rgba(42,74,107,0.05));
                ...
                <div style='font-family:"Cormorant Garamond",serif;font-style:italic;
                            font-size:0.78rem;color:rgba(245,237,214,0.55);margin-top:0.2rem;'>"Mystro"</div>
                <div style='font-family:"Raleway",sans-serif;font-size:0.65rem;
                            text-transform:uppercase;letter-spacing:0.12em;color:#9A8A6A;
        ...
        <div style='background:rgba(201,168,76,0.06);border:1px solid rgba(201,168,76,0.15);
            ...
            <div style='font-family:"Cormorant Garamond",serif;font-style:italic;
                        font-size:0.95rem;color:rgba(245,237,214,0.75);line-height:1.6;'>
...
# ══════════════════════════════════════════════════════════════════════════════
    ...
    with col1:
        ...
        <div style='background:linear-gradient(160deg,rgba(201,168,76,0.1),rgba(201,168,76,0.02));
            ...
            <div style='font-family:"Cormorant Garamond",serif;font-style:italic;
                        font-size:1.1rem;color:rgba(245,237,214,0.7);margin-top:0.3rem;'>
            ...
            <div style='font-family:"Raleway",sans-serif;font-size:0.92rem;
                        color:rgba(245,237,214,0.85);line-height:1.7;'>
        ...
        for icon, fact in [
            ...
            ("🏫", "Beloved teacher in Aliquippa schools"),
            ...
            <div style='background:rgba(201,168,76,0.05);border:1px solid rgba(201,168,76,0.12);
                ...
                <span style='font-family:"Raleway",sans-serif;font-size:0.85rem;
                             color:rgba(245,237,214,0.85);'>{fact}</span>
            </div>
            """, unsafe_allow_html=True)
    ...
    <p style='font-family:"Raleway",sans-serif;font-size:1rem;color:rgba(245,237,214,0.85);
        ...
        with col:
            ...
            <div class="card" style='padding:1.8rem;text-align:center;'>
                ...
                <div style='font-family:"Raleway",sans-serif;font-size:0.85rem;
                            color:rgba(245,237,214,0.75);line-height:1.6;'>{desc}</div>
            </div>
            """, unsafe_allow_html=True)
...
# ══════════════════════════════════════════════════════════════════════════════
    ...
    <p style='font-family:"Cormorant Garamond",serif;font-style:italic;
              color:rgba(245,237,214,0.7);font-size:1.1rem;margin-bottom:2rem;'>
        "Lyric" · Wordsmith · Educator · Gospel Minister · Grammy Award Winner
    </p>
    """, unsafe_allow_html=True)
    ...
    with col1:
        ...
        for heading, body in [
            ...
            ("Teacher of Aliquippa",
             "Even as his songs climbed the charts, Melvin returned to Aliquippa and taught in the "
             "local school system. Students who sat in his classroom had no idea their teacher's song "
             "was playing on radio stations across the country. Former students remember him decades "
            ...
            <p style='font-family:"Raleway",sans-serif;line-height:1.85;
                      color:rgba(245,237,214,0.88);font-size:0.97rem;'>{body}</p>
            """, unsafe_allow_html=True)
    ...
    with col2:
        ...
        <div style='background:linear-gradient(160deg,rgba(201,168,76,0.1),rgba(201,168,76,0.02));
            ...
            <div style='font-family:"Cormorant Garamond",serif;font-style:italic;
                        color:rgba(245,237,214,0.6);font-size:0.85rem;margin-top:0.3rem;'>
        ...
        for icon, title, sub in [
            ...
            ("🙏","Minister","Gospel songwriter & man of faith"),
        ]:
            st.markdown(f"""
...
# ══════════════════════════════════════════════════════════════════════════════
    ...
    <p style='font-family:"Cormorant Garamond",serif;font-style:italic;
              color:rgba(245,237,214,0.7);font-size:1.1rem;margin-bottom:2rem;'>
        "Mystro" · Melodist &amp; Pianist · Co-writer · Grammy Award Winner
    </p>
    """, unsafe_allow_html=True)
...
# ══════════════════════════════════════════════════════════════════════════════
    ...
    with col1:
        ...
        <div style='background:linear-gradient(135deg,#1A1208,#2E1F06,#0D0A06);
            ...
            <div style='font-family:"Cormorant Garamond",serif;font-size:0.78rem;
                        font-style:italic;color:rgba(245,237,214,0.4);margin-top:0.3rem;'>
    ...
    with col2:
        st.markdown("""
        <div style='background:linear-gradient(135deg,#1A1208,#221808);
        ...
        for icon, name in [("🎵","Apple Music"),("🟢","Spotify"),("▶️","YouTube Music"),("📀","Amazon Music")]:
            st.markdown(f"""
        ...
        <div style='margin-top:1.5rem;padding:1rem;background:rgba(201,168,76,0.06);
            ...
            <div style='font-family:"Raleway",sans-serif;font-size:0.85rem;
                        color:rgba(245,237,214,0.8);line-height:1.8;'>
    ...
    with col2:
        ...
        <div class="card" style='text-align:center;padding:2rem;'>
            ...
            <div style='margin-top:1rem;font-family:"Cormorant Garamond",serif;
                        font-size:0.78rem;font-style:italic;color:rgba(245,237,214,0.4);'>
...
# ══════════════════════════════════════════════════════════════════════════════
    ...
    timeline = [
        ("1942", "Born in Aliquippa, PA", "Twin brothers Melvin and Mervin Steals are born and raised in Aliquippa — a Beaver County mill town on the Ohio River."),
        ...
        ("80s–90s", "Educator & Community", "Melvin teaches in the Aliquippa school system while both brothers continue writing. Mervin deepens his business partnership with McKinley Jackson."),
    ...
    for song, artist, year, notes in songs:
        ...
        for col, val, clr in zip(row_cols, [song, artist, year, notes],
            ...
            <div style='display:flex;gap:1rem;margin-bottom:1rem;align-items:flex-start;'>
                ...
                <div>
                    ...
                    <div style='font-family:"Raleway",sans-serif;font-size:0.87rem;
                                color:rgba(245,237,214,0.85);margin-top:0.2rem;line-height:1.5;'>{val}</div>
                </div>
            </div>
            """, unsafe_allow_html=True)
