...
/* Hide sidebar on mobile, keep accessible via hamburger */
[data-testid="stSidebar"] {
    background: linear-gradient(180deg, #F5F0E8 0%, #EDE5D0 100%) !important;
...
with st.sidebar:
    ...
    <div style='margin-top:2rem; padding:1rem; border:1px solid rgba(201,168,76,0.15);
        ...
        <div style='font-family:"Cormorant Garamond",serif; font-size:0.75rem;
                    font-style:italic; color:rgba(44,36,22,0.5); margin-top:0.2rem;'>
            2021 — "10%" · Kaytranada
        </div>
    </div>
    """, unsafe_allow_html=True)
...
# Prefer the mobile selectbox; fall back to sidebar
page = mobile_page if mobile_page else sidebar_page
...
if "Home" in page:
    ...
    file_id = "1Mp8mkfpW0BvJNahmErKkpm5DXRR8nxML"
