...
# ══════════════════════════════════════════════════════════════════════════════
    ...
    photo_col1, photo_col2 = st.columns(2, gap="large")
    with photo_col1:
        st.image("twinsOldHouse.webp", caption="Melvin & Mervin on their porch in Aliquippa — the early years", use_container_width=True)
    with photo_col2:
        st.image("MoreCurrentPic.webp", caption="Melvin & Mervin Steals Sr. — still brothers, still writing history", use_container_width=True)
...
# ══════════════════════════════════════════════════════════════════════════════
    ...
    with col2:
        st.image("MelvinandAdrena.jpg", caption="Melvin and Adrena Steals with Billy Henderson of The Spinners at the Civic Arena, 1976", use_container_width=True)
...
# ══════════════════════════════════════════════════════════════════════════════
    ...
    st.markdown("""
    <p class="section-eyebrow" style="text-align:center;">Original Sheet Music</p>
    <h3 style='font-family:"Playfair Display",serif;color:#C9A84C;
               font-size:1.8rem;margin-bottom:0.5rem;text-align:center;'>
        "Could It Be I'm Falling in Love"
    </h3>
    <p style='font-family:"Cormorant Garamond",serif;font-style:italic;
              color:rgba(44,36,22,0.65);font-size:0.95rem;text-align:center;margin-bottom:1rem;'>
        Words and Music by Melvin Steals and Mervin Steals
    </p>
    """, unsafe_allow_html=True)
    notes_col1, notes_col2, notes_col3 = st.columns([1, 3, 1])
    with notes_col2:
        st.image("Notes.jpg", caption="Original sheet music for 'Could It Be I'm Falling in Love' — words by Melvin, music by Mervin", use_container_width=True)
